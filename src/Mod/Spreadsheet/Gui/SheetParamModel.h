...
#ifndef SHEETPARAMMODEL_H
#define SHEETPARAMMODEL_H
...
class SheetParamModel: public QAbstractTableModel
{
    Q_OBJECT
public:
    explicit SheetParamModel(Spreadsheet::Sheet* _sheet, QObject* parent = nullptr);
    ~SheetParamModel() override;

    explicit SheetParamModel(QObject* parent);
