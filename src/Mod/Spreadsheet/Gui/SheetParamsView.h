...
#ifndef SHEETPARAMSVIEW_H
#define SHEETPARAMSVIEW_H
...
class SheetParamsView: public QTableView
{
    Q_OBJECT
public:
    explicit SheetParamsView(QWidget* parent = nullptr);
    ~SheetParamsView() override;
